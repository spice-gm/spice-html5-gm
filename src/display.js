...
{   
    switch (msg.type) {
        ...
        case Constants.SPICE_MSG_DISPLAY_DRAW_COPY:
            ...
            if (draw_copy.data && draw_copy.data.src_bitmap) {
                ...
                if (draw_copy.data.src_bitmap.descriptor.type == Constants.SPICE_IMAGE_TYPE_QUIC) {
                    ...
                    var tmpstr = 'data:image/jpeg;base64,' + window.btoa(String.fromCharCode(...new Uint8Array(draw_copy.data.src_bitmap.jpeg.data)));
                    var img = new Image;
                    // var i;
        ...
        case Constants.SPICE_MSG_DISPLAY_STREAM_DATA:
            var m = new Messages.SpiceMsgDisplayStreamData(msg.data);
        ...
        case Constants.SPICE_MSG_DISPLAY_STREAM_DATA_SIZED:
            var m = new Messages.SpiceMsgDisplayStreamDataSized(msg.data);
            if (!this.streams[m.base.id]) {
                console.log("no stream for data");
                return false;
            }
